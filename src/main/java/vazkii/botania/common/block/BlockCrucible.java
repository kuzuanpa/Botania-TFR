...
public class BlockCrucible extends BlockTerraContainer 
{
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer entityplayer, int par6, float par7, float par8, float par9)
	{
		if(!world.isRemote && (TECrucible)world.getTileEntity(i, j, k) != null)
		{
			...
			entityplayer.openGui(Botania.instance, LibGuiIDs.TFCCrucible, world, i, j, k);
		}
		return true;
	}
	...
	{
		icons = new IIcon[2];
		icons[0] = iconRegisterer.registerIcon("botania" + ":" + "devices/Crucible Top");
		icons[1] = iconRegisterer.registerIcon("botania"+ ":" + "devices/Crucible Side");
	}
	...
	{
		return ModBlocks.crucibleRenderId2;
	}
