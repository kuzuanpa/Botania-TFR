...
public final class ModBlocks {
	...
	public static Block manaCrucible;
	public static Block manaForge;

	public static int crucibleRenderId2;
	public static void init() {
		...
		manaCrucible= new BlockCrucible();
		manaForge= new BlockManaForge();

		GameRegistry.registerBlock(manaCrucible,manaCrucible.getUnlocalizedName());
		
		GameRegistry.registerBlock(manaForge,manaForge.getUnlocalizedName());
	...
	private static void initTileEntities() {
		registerTile(TEForge.class, "TEForge");
		registerTile(TECrucible.class, "TECrucible");
		...
		BotaniaAPI.registerSubTile(LibBlockNames.SUBTILE_MUSICDANCLIUS, SubTileMusicDanclius.class);
		...
		BotaniaAPI.registerSubTile(LibBlockNames.SUBTILE_RAFFLOWSIA_PLUS, SubTileRafflowsiaPlus.class);
