...
public final class LexiconData {
	...
	public static LexiconEntry rafflowsiaPlus;
	...
	public static LexiconEntry manaCrucible;
	public static LexiconEntry manaForge;
	public static LexiconEntry TFC;
	public static void init() {
		...
		// BASICS ENTRIES
		TFC = new BLexiconEntry("TFC", categoryBasics);
		TFC.setPriority().setLexiconPages(new PageText("0"));
		...
		runicAltar.setPriority().setLexiconPages(new PageText("21"),new PageText("0"), new PageText("1"),
				new PageCraftingRecipe("2", ModCraftingRecipes.recipesRuneAltar), new PageCraftingRecipe("23", ModCraftingRecipes.recipeRuneofWater),new PageText("3"), new PageText("20"),
		...
		blackLotus.addExtraDisplayedRecipe(new ItemStack(ModItems.blackLotus));
		  ...
		  flowerBag.setLexiconPages(new PageText("0"), new PageText("2"), new
		  PageCraftingRecipe("1", ModCraftingRecipes.recipeFlowerBag));
		 
		
		manaCrucible = new BLexiconEntry(LibLexicon.manaCrucible, categoryBasics);
		manaCrucible.setLexiconPages(new PageText("0"),new PageCraftingRecipe("1", ModCraftingRecipes.recipemanaCrucible));
		
		manaForge = new BLexiconEntry(LibLexicon.manaForge, categoryBasics);
		manaForge.setLexiconPages(new PageText("0"),new PageCraftingRecipe("1", ModCraftingRecipes.recipemanaForge));
		...
		loonium.setLexiconPages(new PageText("0"));
		...
		rafflowsiaPlus = new ALexiconEntry(LibLexicon.GFLOWER_RAFFLOWSIA_PLUS, categoryGenerationFlowers);
		rafflowsiaPlus.setLexiconPages(new PageText("0"), new PageText("1"),
				new PagePetalRecipe<>("2", ModPetalRecipes.rafflowsiaPlusRecipe));
		...
		terraBlade.setLexiconPages(new PageText("0"));
