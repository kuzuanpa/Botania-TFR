...
public class PageTerrasteel extends PageRecipe {
	...
	public void renderRecipe(IGuiLexiconEntry gui, int mx, int my) {
		...
		renderItem(gui, gui.getLeft() + gui.getWidth() / 2 - 8, gui.getTop() + 80, new ItemStack(TFCItems.blackSteelIngot, 1), false);
		renderItem(gui, gui.getLeft() + gui.getWidth() / 2 - 8, gui.getTop() + 90, new ItemStack(ModItems.manaResource, 1,7), false);
		renderItem(gui, gui.getLeft() + gui.getWidth() / 2 - 8 - 20, gui.getTop() + 86, new ItemStack(ModItems.manaResource, 1, 8), false);
