...
public final class LibLexicon {
	...
	public static final String manaCrucible = "manaCrucible";
	public static final String manaForge = "manaForge";
	...
	public static final String GFLOWER_RAFFLOWSIA_PLUS = "rafflowsiaPlus";
