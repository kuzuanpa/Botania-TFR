...
public class ModElvenTradeRecipes {
	...
	public static void init() {
		...
		elementiumRecipes.add(BotaniaAPI.registerElvenTradeRecipe(new ItemStack(ModItems.manaResource, 2, 7), new ItemStack(TFCItems.redSteelIngot),new ItemStack(TFCItems.blueSteelIngot), LibOreDict.MANA_STEEL));
		elementiumRecipes.add(BotaniaAPI.registerElvenTradeRecipe(new ItemStack(ModItems.manaResource, 1, 7), new ItemStack(TFCItems.blueSteelIngot), LibOreDict.MANA_STEEL));
		elementiumRecipes.add(BotaniaAPI.registerElvenTradeRecipe(new ItemStack(ModItems.manaResource, 1, 7), new ItemStack(TFCItems.redSteelIngot), LibOreDict.MANA_STEEL));
		...
		pixieDustRecipe = BotaniaAPI.registerElvenTradeRecipe(new ItemStack(ModItems.manaResource, 1, 8), new ItemStack(ModItems.manaResource, 1, 9));
