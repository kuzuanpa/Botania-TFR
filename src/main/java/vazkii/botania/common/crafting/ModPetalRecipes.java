...
public final class ModPetalRecipes {
	...
	public static final String flowerblue= LibOreDict.FLOWER[11],flowerLightBlue = LibOreDict.FLOWER[3];
	...
	public static RecipePetals hydroangeasRecipe2;
	...
	public static RecipePetals rafflowsiaPlusRecipe;
	...
	public static void init() {
		...
		endoflameRecipe = BotaniaAPI.registerPetalRecipe(ItemBlockSpecialFlower.ofType(LibBlockNames.SUBTILE_ENDOFLAME), brown, brown, red, lightGray, new ItemStack(ModItems.rune, 1, 1));
		...
		hydroangeasRecipe2 = BotaniaAPI.registerPetalRecipe(ItemBlockSpecialFlower.ofType(LibBlockNames.SUBTILE_HYDROANGEAS), lightBlue, lightBlue, cyan, cyan);
		...
		rafflowsiaPlusRecipe = BotaniaAPI.registerPetalRecipe(ItemBlockSpecialFlower.ofType(LibBlockNames.SUBTILE_RAFFLOWSIA_PLUS), purple, purple, black, runeEarth, runePride, runeGreed, runeGluttony, gaiaSpirit);
