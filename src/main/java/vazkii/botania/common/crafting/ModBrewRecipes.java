...
public class ModBrewRecipes {
	...
	public static void init() {
		speedBrew = BotaniaAPI.registerBrewRecipe(ModBrews.speed, new ItemStack(Items.nether_wart), ItemManaCookie.createTag(new ItemStack(TFCItems.sugar), 2), new ItemStack(Items.redstone));
		...
		hasteBrew = BotaniaAPI.registerBrewRecipe(ModBrews.haste, new ItemStack(Items.nether_wart), ItemManaCookie.createTag(new ItemStack(TFCItems.sugar), 2), new ItemStack(Items.gunpowder));
		...
		resistanceBrew = BotaniaAPI.registerBrewRecipe(ModBrews.resistance, new ItemStack(Items.nether_wart), new ItemStack(TFCItems.wroughtIronIngot), new ItemStack(Items.leather));
		...
		overloadBrew = BotaniaAPI.registerBrewRecipe(ModBrews.overload, new ItemStack(Items.nether_wart), new ItemStack(Items.blaze_powder), ItemManaCookie.createTag(new ItemStack(TFCItems.sugar), 2), new ItemStack(Items.glowstone_dust), new ItemStack(ModItems.manaResource), new ItemStack(Items.spider_eye));
