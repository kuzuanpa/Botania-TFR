...
public final class ModManaInfusionRecipes {
	...
	public static RecipeManaInfusion end;
	public static void init() {
		
		end=BotaniaAPI.registerManaInfusionRecipe(new ItemStack(Blocks.end_stone),new ItemStack(Blocks.netherrack), 10000);
		...
		manaCookieRecipe = BotaniaAPI.registerManaInfusionRecipe(ItemManaCookie.createTag(new ItemStack(ModItems.manaCookie),8), new ItemStack(Items.cookie), 20000);
