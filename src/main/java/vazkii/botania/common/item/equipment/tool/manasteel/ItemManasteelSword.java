...
public class ItemManasteelSword extends ItemCustomSword implements IManaUsingItem {

	public static final int MANA_PER_DAMAGE = 60;

	public static IIcon elucidatorIcon;

	public static float weaponBaseDamage = 250f;

	public ItemManasteelSword() {
		this(BotaniaAPI.manasteelToolMaterial, weaponBaseDamage, LibItemNames.MANASTEEL_SWORD);
	}

	public ItemManasteelSword(ToolMaterial mat,float damage ,String name) {
		super(mat, damage);
